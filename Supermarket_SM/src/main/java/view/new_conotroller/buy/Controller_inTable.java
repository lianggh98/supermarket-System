...
public class Controller_inTable  extends ViewAssistImpl implements Initializable {

    private static BuyVo buyVo;

    public static void setBuyVo(BuyVo buyVo) {
        Controller_inTable.buyVo = buyVo;
    }
    ...
    public void B_update(){
        ...
        new Thread(()->{
            /**发送给服务层**/
            Integer inid = inTableSerivce.inTableUpdate(strings,timestamp);
            /**开启新线程操作Stock库**/
